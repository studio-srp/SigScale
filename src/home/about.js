                ...
                <div class="about-left">
                    <div class="about-header-area">
                        ...
                        <p class="about-left__description">
                            SigScale is an open source company focused on software solutions for
                            communications service providers (CSP).
                        </p>
                        <p class="about-left__description">
                            Our core competency is in signaling and distributed fault tolerant
                            systems. We have developed our own protocol stacks (SIGTRAN, TCAP, CAP,
                            MAP, NGAP, RADIUS, EAP) in Erlang, allowing us to build microservices
